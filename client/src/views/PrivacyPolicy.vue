...
<template>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to Airsoft 4 Ohio.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Airsoft 4 Ohio, accessible from <a href="https://airsoft4ohio.com"
                        rel="external nofollow noopener" target="_blank">https://airsoft4ohio.com</a></p>
            </li>
            <li>
    ...
    <ul>
        <li>
            By email: <a href="mailto:support@cincitechlabs.com">support@cincitechlabs.com</a>
        </li>
    </ul>
</div></template>